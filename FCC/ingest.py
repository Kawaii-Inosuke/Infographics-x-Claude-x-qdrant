...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Base directory containing brand folders (default: parent of this script's folder)",
    )
    parser.add_argument("--brand-dir", type=str, default=".", help="Folder containing brand images (default: .)")
